...
public class ShopService1 {
    ...
    public void init(){
        ...
        zkClient.createEphemeral(PATH+"/"+serviceName+"/192.168.1.12:8080");
        System.out.println("提供服务节点ShopService:"+PATH+"/"+serviceName+"/192.168.1.12:8080");
    }

    public static void main(String[] args) throws IOException {
        ShopService1 shopService=new ShopService1();
        shopService.init();
